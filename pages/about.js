    ...
    <WrapperContainer>
      ...
      <Flex flexDirection={{ base: "column", md: "row" }} gap={"10"}>
        ...
        <Flex flexDirection={"column"}>
          ...
          >
            ...
            Medium School in Sundarijal. So it was a challenge for our School to
            get more students at that time. As well as the people status were
            very low at that time so the parents preferred to send their
      ...
      <Flex flexDirection={{ base: "column", md: "row-reverse" }} gap={"10"}>
        ...
        <Text fontSize={"xs"} textColor={"gray.500"} mt={"15"}>
          ...
          throughout this time. Children at this age have a tremendous amount of
          energy and curiosity, which needs to be properly channeled and handled
          ...
          higher-order thinking and performance and we take care of every little
          thing to keep an eye on the development of the kids. Genius employs
          all available tools to engage and train kids to become self-assured
          and independent, from straightforward presentations to intricate
          critical thinking. Therefore it creates efficient systems, offers
          suitable counsel, promotes plans, and oversees implementations and
          assessments. Through rules pertaining to classroom decorum, behavioral
          etiquette, maintaining property, and respecting everyone, children are
          made aware of their specific roles as well as their general
          responsibilities in this environment. This aids in progressively
          instilling values like empathy, ethics, a sense of ownership, and
          compassion in the developing minds of the kids.
          <br />
          <br />
          ...
          one unit. Every employee at Genius English School works assiduously to
          fulfill their roles in attaining the company&apos;s mission. We
          respect the hopes and aspirations you share for your child. Therefore,
          we share your hopes when you choose Genius English School for your
          child&apos;s education. We appreciate your selection and are aware of
          your expectations. As always, your pleasure is our first priority.
        </Text>
      </Flex>
